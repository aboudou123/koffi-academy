...
(function () {
  ...
  function readme(c) {
    return [
      ...
      "| Feld | Wert |",
      "| --- | --- |",
      "| Kubernetes Namespace | " + c.namespace + " |",
      "| Service Port | " + c.servicePort + " |",
      "| Container Port | " + c.containerPort + " |",
      "| Ingress Host | " + c.serviceHost + " |",
      "| Pipeline | " + c.pipelineName + " |",
      "| Repository | " + c.githubOwner + "/" + c.repositoryName + " |",
      "| CODEOWNER | @" + c.codeOwnerUsername + " |",
      "",
      "## Enthaltene Artefakte",
      "- Backstage Catalog Entity (catalog-info.yaml)",
      "- TechDocs-Grundstruktur (docs/, mkdocs.yml)",
      "- Dockerfile",
      "- CI/CD-Pipeline-Grundlage (.github/workflows/ci.yml, azure-pipelines.yml)",
      "- Kubernetes Deployment",
      "- Kubernetes Service",
      "- Kubernetes Ingress",
      "- CODEOWNERS",
      "- Security-Datei (SECURITY.md)",
      "- Runbook (docs/runbook.md)",
      "- Readiness Checkliste (readiness-checklist.md)",
      "",
      "## Lokale Entwicklung",
      "```bash",
